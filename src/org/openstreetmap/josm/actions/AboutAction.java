...
public class AboutAction extends JosmAction {
    ...
    //  static String getResource((java.net.URL s)
    //    {
	// FIXME
    //	return s;
    //    }
	...
	//readme.setText(Version.loadResourceFile(getResource("/README")));

        JTextArea contribution = new JTextArea();
        contribution.setEditable(false);
	//        contribution.setText(Version.loadResourceFile(getResource("/CONTRIBUTION")));

        JTextArea license = new JTextArea();
        license.setEditable(false);
	//        license.setText(Version.loadResourceFile(getResource("/LICENSE")));
