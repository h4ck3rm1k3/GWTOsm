...
import org.openstreetmap.josm.gui.dialogs.changeset.query.EditLayerObject;
...
public class DeleteAction extends MapMode implements AWTEventListener {
    public DeleteAction(String name, String iconName, String tooltip,
			MapFrame mapFrame, Cursor cursor) {
	...
	public DeleteAction(MapFrame mapFrame) {
		// TODO Auto-generated constructor stub
		super(mapFrame.getName(), mapFrame.getIconName(), mapFrame.getTooltip(), mapFrame, mapFrame.getCursor());
	}

	public DeleteAction(MapObject mapFrame) {
		// TODO Auto-generated constructor stub
		super(mapFrame.getName(), mapFrame.getIconName(), mapFrame.getTooltip(), mapFrame, mapFrame.getCursor());
	}
     ...
     * @param map The frame this action belongs to.
     */
//    public DeleteAction(MapObject map) {
...
//	}
	...
	public static void deleteRelation(EditLayerObject editLayer,
			Relation toDelete) {
