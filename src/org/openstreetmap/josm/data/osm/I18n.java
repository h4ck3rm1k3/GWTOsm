...
import org.openstreetmap.josm.data.coor.Locale;
...
public class I18n {
    ...
    public static final Locale[] getAvailableTranslations() {
        ...
        // if(getResource("/data/en.lang") != null)
        // {
        //     for (String loc : languages.keySet()) {
        //         if(getResource("/data/"+loc+".lang") != null) {
        //             int i = loc.indexOf('_');
        //             if (i > 0) {
    ...
    private static boolean load(String l)
    {
        ...
        //     return true;
        // }
        // URL en = getResource("/data/en.lang");
        // if(en == null)
        //     return false;
        // URL tr = getResource("/data/"+l+".lang");
        // if(tr == null)
        // {
        //     int i = l.indexOf('_');
        //     if (i > 0) {
