...
public class Color //extends com.google.gwt.widgetideas.graphics.client.Color
{
	...
	public Color(int parseInt, int parseInt2, int parseInt3, int i) {
		// TODO Auto-generated constructor stub
	//	super(parseInt, parseInt2, parseInt3,i);
	}
