...
public class Multipolygon {
    ...
    public static class PolyData {
        ...
        public PolyData(INavigatableComponent nc, JoinedWay joinedWay) {
            this(nc, joinedWay.getNodes(), joinedWay.isSelected());
        }

        public PolyData(INavigatableComponent nc, List<Node> nodes, boolean selected) {
            this.selected = selected;
            Point p = null;
            for (Node n : nodes)
            {
    ...
    public Multipolygon(INavigatableComponent nc) {
        this.nc = nc;
    }
