...
import java.util.AbstractList; //import java.util.ConcurrentModificationException;
import java.util.Iterator;
import java.util.NoSuchElementException;
import java.util.RandomAccess;

/**
 * A List implementation initially based on given array, but never modifying the
 * array directly. On the first modification, the implementation will create its
 * own copy of the array, and after that it behaves mostly as an ArrayList.
 * 
 * @author nenik
 */
public final class CopyList<E> extends AbstractList<E> implements RandomAccess,
	 ...
	 * 
	 * @param array
	 *            The initial List content. The array is never modified by the
	 *            {@code CopyList}.
	 */
