...
public class GpxLayer extends Layer {
	...
	private boolean draw_rawgps_direction;
	private boolean draw_rawgps_hdopcircle;
	private boolean draw_rawgps_large;
	private boolean draw_rawgps_lines;
	private boolean draw_rawgps_lines_force;
	private int draw_rawgps_linewidth;
	private int draw_rawgps_max_line_length;
	private float hdop_factor;
    ...
    static public Color gps_point_color; // Color.gray
    static public Color getColor(String name) {
	return gps_point_color; //--Color.gray);
    }
    ...
    static boolean draw_rawgps_lines_localfiles;
    static boolean draw_rawgps_colors;
    static boolean draw_rawgps_alternatedirection;
    static int draw_rawgps_min_arrow_distance;
    static int draw_rawgps_colorTracksTune;
    static boolean marker_audiofromnamedtrackpoints;
    ...
    public void paint(Graphics2D g, MapView mv, Bounds box) {
        ...
        boolean forceLines = draw_rawgps_lines_force;
        // draw direction arrows on the lines
        boolean direction = draw_rawgps_direction;
        // don't draw lines if longer than x meters
        int lineWidth = draw_rawgps_linewidth;

        int maxLineLength;
        if (this.isLocalFile) {
            int draw_rawgps_max_line_length_local;
			maxLineLength = draw_rawgps_max_line_length_local; //-1
        } else {
            maxLineLength = draw_rawgps_max_line_length; // 200
        }


        // draw line between points, global setting
        boolean lines = (draw_rawgps_lines || (draw_rawgps_lines_localfiles) && this.isLocalFile);
...
//       }
        ...
        boolean large = draw_rawgps_large;
        boolean hdopcircle = draw_rawgps_hdopcircle;
        // color the lines
        colorModes colored = colorModes.none;
        try {
            colored = colorModes.values()[draw_rawgps_colors];
        } catch (Exception e) {
        }
        // paint direction arrow with alternate math. may be faster
        boolean alternatedirection = draw_rawgps_alternatedirection;
        // don't draw arrows nearer to each other than this
        int delta = draw_rawgps_min_arrow_distance;
        // allows to tweak line coloring for different speed levels.
        int colorTracksTune = draw_rawgps_colorTracksTune;
                        ...
                        if (oldWp != null) {
                            ...
                            case dilution:
                                if (trkPnt.attr.get("hdop") != null) {
                                    ...
                                    int hdoplvl = Math.round(hdop * hdop_factor);
    ...
    public class DownloadAlongTrackAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            buffer.setSelectedIndex(PREF_DOWNLOAD_ALONG_TRACK_DISTANCE);
            ...
            maxRect.setSelectedIndex(PREF_DOWNLOAD_ALONG_TRACK_AREA);
    ...
    private void importAudio(File wavFile, MarkerLayer ml, double firstStartTime, Markers markers) {
        ...
        // double snapDistance = marker_audiofromuntimedwaypoints_distance; //, 1.0e-3); 
	// /*
        //  * about
        //  * 25
        //  * m
        ...
        // if (marker_audiofromexplicitwaypoints && data.waypoints != null
        ...
        // if (marker_audiofromuntimedwaypoints && data.waypoints != null
        //         && !data.waypoints.isEmpty()) {
        //     for (WayPoint w : data.waypoints) {
        ...
        // // if (marker_audiofromnamedtrackpoints) && data.tracks != null
        // //         && !data.tracks.isEmpty()) {
        // //     for (GpxTrack track : data.tracks) {
        // //         for (GpxTrackSegment seg : track.getSegments()) {
        // //             for (WayPoint w : seg.getWayPoints()) {
        ...
        // if ((marker_audiofromwavtimestamps) && data.tracks != null
        //         && !data.tracks.isEmpty()) {
	...
	// 	/ audio_calibration /* default, ratio */);
        //     WayPoint w1 = null;
        //     WayPoint w2 = null;
        ...
        // if ((marker_audiofromstart) || waypoints.isEmpty()) && data.tracks != null
        //         && !data.tracks.isEmpty()) {
